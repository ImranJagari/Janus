...
namespace Janus.Core.Utils
{
    public static class NLogHelper
    {
        public static string LogFormatConsole = "[${callsite:className=true:methodName=false:includeSourcePath=false:includeNamespace=false}](${threadid}) ${message}";
